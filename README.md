...
<body>
    ...
    <div class="modal" id="orderModal">
        ...
        <div class="info-banner">
            <i class="fas fa-info-circle"></i> Commande envoyée au +225 66 72 72 93
        </div>
        ...
        <form id="orderForm" onsubmit="submitOrder(event)">
            <!-- Sur Place Fields - Uniquement numéro de table -->
    ...
    <script>
        // WhatsApp Number
        const WHATSAPP_NUMBER = '22566727293';

        // Menu Data - Prix tacos mis à jour
        const menuData = {
            viennoiseries: [
            ...
            fastfood: [
                ...
                { id: 8, name: "Tacos viande", price: 2500, icon: "🌮", desc: "Tacos avec viande hachée" }, // Prix mis à jour
                { id: 9, name: "Tacos poulet", price: 3500, icon: "🌮", desc: "Tacos avec poulet pané" }, // Prix mis à jour
                { id: 10, name: "Tacos THILAL", price: 4500, icon: "🌮", desc: "Tacos spécial maison", badge: "SPECIAL" }, // Prix mis à jour
        ...
        function selectOrderType(type, btn) {
            ...
            if (type === 'surplace') {
                ...
                // Sur place: uniquement table requise
                ...
                // Livraison: nom, téléphone, quartier, adresse requis
